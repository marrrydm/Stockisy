...
class OnboardingThird: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        logoView.image = OnboardingViewModel.init().items?[2].images[0]
        labelTitle.text = OnboardingViewModel.init().items?[2].title
        contentLabel.text = OnboardingViewModel.init().items?[2].content
    }
